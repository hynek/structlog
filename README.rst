...
Full documentation can be found at `http://www.structlog.org/ <http://www.structlog.org>`_.
Find out what’s new from the `changelog <http://www.structlog.org/en/latest/changelog.html>`_!
